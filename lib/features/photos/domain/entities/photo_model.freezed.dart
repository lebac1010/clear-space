...
class _$PhotoModelImpl implements _PhotoModel {
  ...
  @override
  String toString() {
    return 'PhotoModel(id: $id, name: $name, path: $path, uri: $uri, size: $size, dateModified: $dateModified)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, path, uri, size, dateModified);
...
abstract class _PhotoModel implements PhotoModel {
  const factory _PhotoModel(
      ...
      required final DateTime dateModified}) = _$PhotoModelImpl;
